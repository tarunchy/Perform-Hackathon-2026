...
Learning Resources
Dynatrace Synthetics for SRE and DevOps

Step 7: Additional Token for DTChallenge-03
DTChallenge-03 (Improve your Dynatrace Setup) requires an additional token to interact with Dynatrace's Configuration API for creating synthetic tests, dashboards, and workflows.

Token Variable: DYNATRACE_CONFIG_API_TOKEN

Token Value: Its part secret Provided